...
public class ShangxiazuangZongheAnalysisAcitivity extends AbstractActivity implements OnTouchListener{
	...
	private void initData() {
		...
		listFooter = ListViewUtils.generateRow(new String[]{
				"合计", sumWareAll+"", "100%", sumWareCnt+"", "100%", 
				formatter.format((((double)sumWareCnt/sumWareAll)*100))+"%",
				sumAmount+"",
				"100%",
				sumPrice+"",
				"100%"
...
//		mAdapter.notifyDataSetChanged();
	...
	public void onClick(View v) {
		...
		case R.id.charts_btn:
			...
			bundle.putInt(DaleiPipeChartActivity.ANA_TYPE, DaleiPipeChartActivity.ANATYPE_SXZ);
			bundle.putInt(DaleiPipeChartActivity.OPT_TYPE, CommonDataUtils.ZKZB);
			bundle.putString(DaleiPipeChartActivity.ANA_TITLE, "上下装分析-总款占比");
	...
	public boolean onTouch(View v, MotionEvent event) {
			...
			if(!isBoduanListDialogShow) {
				final AsListDialog boduanListDialog = 
					DialogUtils.makeListDialog(
							ShangxiazuangZongheAnalysisAcitivity.this, 
							boduanEt, 
							CommonDataUtils.getBoduan(ShangxiazuangZongheAnalysisAcitivity.this)
						);
			...
			if(!isDaleiListDialogShow) {
				final AsListDialog daleiListDialog = 
					DialogUtils.makeListDialog(
							ShangxiazuangZongheAnalysisAcitivity.this, 
							daleiEt, 
							CommonDataUtils.getWareTypes(ShangxiazuangZongheAnalysisAcitivity.this)
					);
			...
			if(!isXiaoleiListDialogShow) {
				final AsListDialog xiaoleiListDialog = 
					DialogUtils.makeListDialog(
							ShangxiazuangZongheAnalysisAcitivity.this, 
						xiaoleiEt, 
						CommonDataUtils.getType1s(ShangxiazuangZongheAnalysisAcitivity.this)
					);
		...
		case R.id.must_order_theme_et:
			if(!isZhutiListDialogShow) {
				final AsListDialog
					zhutiListDialog = 
						DialogUtils.makeListDialog(ShangxiazuangZongheAnalysisAcitivity.this, zhutiEt, CommonDataUtils.getThemes(ShangxiazuangZongheAnalysisAcitivity.this));
