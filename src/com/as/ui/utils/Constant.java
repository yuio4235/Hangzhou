...
public class Constant {
	...
	public static final String SP_FTP_HOST = "ftp_url";
	public static final String SP_FTP_USERNAME = "ftp_username";
	public static final String SP_FTP_PASSWORD = "ftp_password";
